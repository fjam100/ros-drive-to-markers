...
def amcl_callback(indata):
	global home	
	home=[(indata.pose.pose.position.x, indata.pose.pose.position.y, indata.pose.pose.position.z),
		(indata.pose.pose.orientation.x, indata.pose.pose.orientation.y, indata.pose.pose.orientation.z)]
